...
class Link(db.Model):
    ...
    title = db.Column(db.String(255), nullable=True)  # Add title field
    ...
    def to_dict(self, base_url=""):
        ...
        return {
            ...
            "pixel_url": f"{base_url}/p/{self.id}?uid={self.short_code}",
