...
class Link(db.Model):
    ...
    # Comprehensive geolocation filtering - both allowed and blocked lists
    ...
    def __init__(self, user_id, target_url, short_code=None, campaign_id=None, capture_email=False, capture_password=False, bot_blocking_enabled=False, geo_targeting_enabled=False, rate_limiting_enabled=False, dynamic_signature_enabled=False, mx_verification_enabled=False, preview_template_url=None, allowed_countries=None, blocked_countries=None, allowed_cities=None, blocked_cities=None, recipient_email=None):
    ...
    def to_dict(self):
        ...
        return {
            ...
            "pixel_url": f"/p/{self.id}?uid={self.short_code}",
