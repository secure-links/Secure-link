...
const mockSecurityData = {
  ...
  threatTrend: [
    { date: '2025-08-12', threats: 12, blocked: 8 },
    { date: '2025-08-13', threats: 18, blocked: 15 },
    { date: '2025-08-14', threats: 25, blocked: 22 },
    { date: '2025-08-15', threats: 15, blocked: 13 },
    { date: '2025-08-16', threats: 32, blocked: 28 },
    { date: '2025-08-17', threats: 21, blocked: 19 },
    { date: '2025-08-18', threats: 28, blocked: 25 },
    { date: '2025-08-19', threats: 19, blocked: 17 }
  ],
  protectionFeatures: [
    {
      name: 'Bot Blocking',
  ...
  threatTypes: [
    { name: 'Automated Bots', value: 45, color: '#ef4444' },
    { name: 'Suspicious IPs', value: 25, color: '#f59e0b' },
    { name: 'Geo Violations', value: 15, color: '#8b5cf6' },
    { name: 'Rate Limiting', value: 10, color: '#06b6d4' },
    { name: 'Other', value: 5, color: '#6b7280' }
  ],
  highRiskIPs: [
    { ip: '192.168.1.100', country: 'Unknown', attempts: 15, lastSeen: '2 hours ago', risk: 'High' },
    { ip: '10.0.0.50', country: 'Russia', attempts: 12, lastSeen: '4 hours ago', risk: 'High' },
    { ip: '172.16.0.25', country: 'China', attempts: 8, lastSeen: '6 hours ago', risk: 'Medium' },
    { ip: '203.0.113.45', country: 'Brazil', attempts: 6, lastSeen: '1 day ago', risk: 'Medium' }
  ]
}
...
export function Security() {
  ...
  const fetchSecurityData = async () => {
    ...
    try {
      ...
      // const response = await fetch(`/api/security/analytics?timeframe=${timeframe}`)
